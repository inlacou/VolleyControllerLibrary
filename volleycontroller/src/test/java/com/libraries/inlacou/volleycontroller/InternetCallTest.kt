...
class InternetCallTest {
	...
	fun url_encoding() {
		...
		Assert.assertEquals("https://bigshowi-api-pre.herokuapp.com%2Fapi%2Fvehiculos%2Fmatricula%2F11%20dd", call.url)
		...
		Assert.assertEquals("https://bigshowi-api-pre.herokuapp.com%2Fapi%2Fvehiculos%2Fmatricula%2F11%20dd%3Fname%3Dhola%20primo%26surname%3Dque%20tal", call.url)
